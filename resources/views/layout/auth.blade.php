...
<body>
    <header>
        <nav class="bg-white border-gray-200 dark:bg-gray-900" style="box-shadow: 0 1px 1px rgba(0, 0, 0, 0.254)">
            <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                ...
                <div class="flex items-center md:order-2">
                    <button type="button"
                        ...
                        <img class="w-8 h-8 rounded-full" src="{{ asset($user->image) }}" alt="user photo">
                    </button>
                    <!-- Dropdown menu -->
                    ...
                    <ul
                        ...
                        <li>
                            <a href="{{route('article.create')}}"
                                class="block py-2 pl-3 pr-4 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Create Article</a>
                        </li>
                        <li>
                            <a href="#"
    ...
    <footer class="bg-white rounded-lg shadow dark:bg-gray-900 m-4">
        <div class="w-full max-w-screen-xl mx-auto p-4 md:py-8">
            ...
            <span class="block text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 All Rights Reserved to
                Ayman hh.</span>
        </div>
    </footer>
